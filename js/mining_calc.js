document.getElementById("calc_mining_lvl").addEventListener("click", function() {
    ...
    var total;
    c_s_l_xp = parseInt(xpforlvl[cur_mining_lvl_value]);
    d_s_l_xp = parseInt(xpforlvl[des_mining_lvl_value]);
    if (c_s_l_xp >= cur_mining_xp_value) {
        total = d_s_l_xp - c_s_l_xp;
    } else {
        total = d_s_l_xp - cur_mining_xp_value;
    }
    ...
    mining_xp_needed.innerHTML = "Your need " + total + " more xp for your desired mining Level.";
