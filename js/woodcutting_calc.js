document.getElementById("calc_woodcutting_lvl").addEventListener("click", function() {
    ...
    var total;
    c_s_l_xp = parseInt(xpforlvl[cur_woodcutting_lvl_value]);
    d_s_l_xp = parseInt(xpforlvl[des_woodcutting_lvl_value]);
    if (c_s_l_xp >= cur_woodcutting_xp_value) {
        total = d_s_l_xp - c_s_l_xp;
    } else {
        total = d_s_l_xp - cur_woodcutting_xp_value;
    }
