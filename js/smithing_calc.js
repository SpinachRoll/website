...
document.getElementById("calc_smithing_lvl").addEventListener("click", function() {
    ...
    //total is either current level - desired level, or current xp - desired xp
    ...
    if (flag) {
        ...
        have_total = bronze_total + iron_total + (cur_silv_o_have_value * 13.75) + steel_total + (cur_gold_o_have_value * 22.5) + mith_total + addy_total + rune_total + (cur_bronze_b_have_value * 12.5) + (cur_iron_b_have_value * 25) + (cur_steel_b_have_value * 37.5) + (cur_gold_b_have_value * 30) + (cur_mith_b_have_value * 50) + (cur_addy_b_have_value * 62.5) + (cur_rune_b_have_value * 75);
